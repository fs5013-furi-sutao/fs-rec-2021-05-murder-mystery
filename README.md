...
テーブル分けに従って、REMO のテーブルにご着席ください。

FSマーダーミステリー・REMO：    
https://live.remo.co/e/FrRKjGPMp

以下が REMO のイベント会場です。画像の赤枠のところでテーブル名を確認してください。

![FSマーダーミステリー・REMO](./remo-table.png)

<br />

# ⬛ 👩‍👩‍👧‍👦 テーブル分け

以下に、テーブルごとのメンバを記載します（敬称）。お名前の横にございますダウンロードリンクから、事前にゲーム進行に必要ファイルを各自ダウンロードください。他の方のファイルはダウンロードしないようにお気をつけください（ネタばれしたらオモシロくないよ）。

**執事**👨‍⚖️: 橋本夏樹（気になることがございましたら、なんなりとお申し付けください）
...
ゲーム後にテーブルチェンジでメンバを変えて、ゲームの感想を話しましょう。

<img src="./changed-table.png" />
